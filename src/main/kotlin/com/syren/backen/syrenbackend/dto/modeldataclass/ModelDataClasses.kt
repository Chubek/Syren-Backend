package com.syren.backen.syrenbackend.dto.modeldataclass
...
import com.syren.backen.syrenbackend.service.dataclass.records.*
import java.util.*

data class MonitorDto(val Id: String, val currentStreamId: String, val formerStreams: MutableList<MonitorRecord>, val defaultStreamId: String, val information: MonitorInformation)
